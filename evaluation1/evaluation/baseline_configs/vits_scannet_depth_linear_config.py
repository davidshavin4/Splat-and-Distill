...
data_root = "eval_data/scannet_probe"
...
runner = dict(type="IterBasedRunner", max_iters=307200)
checkpoint_config = dict(by_epoch=False, max_keep_ckpts=2, interval=38400)
evaluation = dict(
    by_epoch=False,
    interval=38400,
    pre_eval=True,
